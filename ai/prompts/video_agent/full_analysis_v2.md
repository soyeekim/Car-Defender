...
자기 점검: 충돌·충격(차체 흔들림, 센서 변화, 급정거)이 감지되었는데 vehicle inventory에 블랙박스 차량 외의 차량이 없다면 분석이 잘못된 것이다.
접촉 시각 전후 프레임을 다시 보고 접촉한 상대 차량을 찾아 반드시 vehicle_2로 등록하라. 화면에 일부만 보이거나 잠깐 보이는 차량도 inventory에 넣는다.
