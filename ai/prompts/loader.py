...
_USER_TAG_PATTERN = re.compile(r"</?\s*(USER_MESSAGE|USER_CASE_DESCRIPTION|FOCUS|CASE_STATE|RETRIEVED_CASES|VERIFIED_CASE_STATE|FAULT_ASSESSMENT|SIMILAR_CASES|OPPONENT_CLAIM)\s*>", re.IGNORECASE)
