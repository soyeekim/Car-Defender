...
mail_body — 위 내용을 보험사 담당자에게 보내는 메일 본문으로 압축한 것. 다음 흐름으로 1,500자 이내:
  인사 및 사건 특정 → 귀사가 제시한 비율(OPPONENT_CLAIM이 있을 때만; 없으면 "제시하신 과실비율에 대해") →
  블랙박스 영상에서 확인되는 핵심 사실 2~3개 → 인정기준·유사 심의사례(번호)와의 비교 → 요청하는 비율
  "나(본 차량) A : 상대 B" → 재검토 요청과 맺음말. 정중한 합니다체, 공격적 표현 없이.
...
- 전체 sections 합계는 3,500자 이내, mail_body는 1,500자 이내.
